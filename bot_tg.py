...
WEBHOOK_PATH = "/bot/53dc5d369033c78b36666ec405f12acb}" 
...
async def on_startup(app: web.Application):
    ...
    WEBHOOK_URL = f"https://api.render.com/deploy/srv-d34puv56ubrc73cks68g?key=k6TzN9WJWOY{os.getenv('RENDER_EXTERNAL_HOSTNAME')}{WEBHOOK_PATH}"
